      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 flex items-center justify-between" style={{ height: 72 }}>
          ...
          <div className="flex items-center gap-3">
            {/* Mode switcher */}
            {mode !== null && (
              <div className="hidden sm:flex items-center gap-1 p-1 rounded-lg" style={{ background: v('surface2'), border: `1px solid ${v('border')}` }}>
                {([
                  { m: 'comparativo' as Mode, label: 'Comparativo', view: 'calculator' as View },
